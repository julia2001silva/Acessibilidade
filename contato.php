    ...
    <div class="container mt-3">
        <main>
                ...
                <div class="row">
                    <div class=" col-xl-6 col-md-6 col-sm-12 d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <p>Aqui você pode tirar todas as suas dúvidas referentes a funcionalidade do site, fazer
                                perguntas referentes ao conteúdo do site e entre outras dúvidas.</p>
                        </div>

                        <div>
                            <h3 class="fw-normal">Faça uma Sugestão</h3>
                            <p>Você pode dar sugestões referente a funcionalidade do site ou até mesmo nos ajudar
                                com os conteúdos do nosso site.</p>
                        </div>

                        <div>
                            <h3 class="fw-normal">Você pode Fazer uma Reclamação</h3>
                            <p>Você também pode fazer uma reclamação como por exemplo sobre um atendimento que recebeu.</p>
                        </div>
                    </div>
            ...
            <aside class="mt-5 d-flex flex-column flex-md-row gap-3 justify-content-between">
                ...
                <div class="mt-4 col-xl-4 col-md-4 col-sm-12">
                    <a class="d-block py-3 btn btn-outline-success d-flex flex-column justify-content-center align-items-center" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" alt="icone de whatsaap" width="25" height="25" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                        ...
                        <p class="m-0">Atendimento Via WhatSapp</p>
                    </a>
                </div>

                <div class="mt-4 col-xl-4 col-md-4 col-sm-12">
                    <a class="d-block py-3 btn btn-outline-warning d-flex flex-column justify-content-center align-items-center" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg"  alt="icone de Telefone" width="25" height="25" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                ...
                <div class="mt-4 col-xl-4 col-md-4 col-sm-12">
                    <a class="d-block py-3 btn btn-outline-primary d-flex flex-column justify-content-center align-items-center" href="mailto:acessibilidadena web@gmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg"  alt="icone de Email" width="25" height="25" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
