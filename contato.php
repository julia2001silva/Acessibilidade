        ...
        <main>
            ...
            <aside class="mt-5 d-flex flex-column flex-md-row gap-3 justify-content-between">
                ...
                <div class="mt-4 col-lg-4">
                    <a class="d-block py-3 btn btn-outline-success d-flex flex-column justify-content-center align-items-center"
                        href="https://wa.me/5511969123654">
                ...
                <div class="mt-4 col-lg-4">
                    <a class="d-block py-3 btn btn-outline-warning d-flex flex-column justify-content-center align-items-center"
                        href="tel:47186325">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                ...
                <div class="mt-4 col-lg-4">
                    <a class="d-block py-3 btn btn-outline-primary d-flex flex-column justify-content-center align-items-center"
                        href="mailto:acessibilidadena web@gmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
